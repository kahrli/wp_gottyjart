...
<article id="missing" class="container">
	<div class="row">
		<div class="col-lg-6 order-lg-2">
			<img src="<?php echo get_bloginfo('template_directory'); ?>/img/404.png" alt="" class="img-fluid">
		</div>
		<div class="col-lg-6 my-auto">
			<header>
				<h2>404: The page you're looking for isn't here!</h2>
				<p>Let Kiki deliver you somewhere else:</p>
			</header>
			<div class="list-group mb-2 mx-auto">
				<a class="list-group-item list-group-item-action active" href="javascript:history.back()">
					<i class="fas fa-step-backward fa-fw"></i>&nbsp;&nbsp;Go Back</a>
				<a class="list-group-item list-group-item-action" href="/blog/index.php">
					<i class="fas fa-home fa-fw"></i>&nbsp;&nbsp;Home</a>
				<a class="list-group-item list-group-item-action" href="/blog/index.php#blog">
					<i class="fas fa-book fa-fw"></i>&nbsp;&nbsp;Blog</a>
				<a class="list-group-item list-group-item-action" href="/blog/index.php#shop">
					<i class="fas fa-shopping-cart fa-fw"></i>&nbsp;&nbsp;Shop</a>
				<a class="list-group-item list-group-item-action" href="https://gottyjart.square.site/gallery">
					<i class="fas fa-images fa-fw"></i>&nbsp;&nbsp;Gallery <i class="fas fa-external-link-square-alt"></i></a>
				<a class="list-group-item list-group-item-action" href="/blog/index.php#about">
...
<article id="shop">
	...
	<div class="card-deck justify-content-around">
		<div class="card card--shop mb-4" id="square" itemscope itemtype="https://schema.org/Store">
			<div class="card-body">
				<h3 class="card-title">
					<a href="https://gottyjart.square.site/s/shop" class="stretched-link" itemprop="brand name">
		                        Square</a></h3>
				<link href="<?php echo get_bloginfo('template_directory'); ?>/img/shop/square.jpg" itemprop="image">
